...
$plugin = plugin::byId('camPatrouille');
...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<?php
		if (count($eqLogics) == 0) {
			echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement CamPatrouille trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
		} else {
			// Champ de recherche
...
<?php include_file('desktop', 'camPatrouille', 'js', 'camPatrouille');?>
